...
layout (input_attachment_index = 0, set = 0, binding = 0) uniform subpassInput inDiffuseColor;
layout (input_attachment_index = 1, set = 0, binding = 1) uniform subpassInput inSpecularColor;
layout (input_attachment_index = 2, set = 0, binding = 2) uniform subpassInput inNormal;
layout (input_attachment_index = 3, set = 0, binding = 3) uniform subpassInput inDepthMatInfo;
layout (input_attachment_index = 4, set = 0, binding = 4) uniform subpassInput inDepth;
